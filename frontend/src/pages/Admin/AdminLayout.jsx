...
import ControleDiarioPage from './ControleDiarioPage';
...
const PAGINAS = [
  ...
  { id: 'controle-diario', label: 'Controle Diario', icon: <FiMapPin />, componente: ControleDiarioPage, rota: '/admin/controle-diario' },
